...
.data
ProgName		TEXTEQU <"Simple Invoice 3.23.8">
...
ScrollText	    		db	"PERYFERiAH tEAM proudly present : ",ProgName," *keYgen* by MaryNello                                                        "
						db  "GFX : r0ger , MSX : frequent , Protection : MD5                                                                            "
						db  "Thx fly out to all my spiritual family and to all my friends out there , including r0ger for templating this keygen ! "
						db  "See you around, have phun!                                                                                   ",0
