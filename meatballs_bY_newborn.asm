...
AboutText 		db "     PERYFERiAH tEAM PrEsEnT",0
				db "KeyGen for Simple Invoice 3.23.8",13,13
				
				db "Cracker    : MaryNello",13
				db "Protection : MD5",13
				db "Date       : 18.12.2o21",13
				db "Music      : <inner energy>",0
				
				db "10x go 2 :",0
				
				db "   r0ger 4 CooL GFX",13
				db "   Frequent 4 Music",13
...
loc_4026D5:                             ; CODE XREF: timerProc+92?j
              ...
              ;  and     eax, 0000000h ; meatball border color 1 (original - 0FF0000h) [ r0ger ]
               ; sub     eax, 00FFFh; meatball border color 2 (original - 0FF0000h) [ r0ger ]
                RGB		255, 145, 0
              ;  shr     eax, 1
                mov     [edi], eax
