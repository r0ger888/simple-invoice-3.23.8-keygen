...
LOCAL ps:PAINTSTRUCT
	...
	.if [uMessg] == WM_INITDIALOG
		...
		invoke ImageButton,xWnd,16,198,500,502,501,IDB_COPY
		mov hCopy,eax
		invoke ImageButton,xWnd,123,200,600,602,601,IDB_ABOUT
		mov hAbout,eax
		invoke ImageButton,xWnd,260,199,700,702,701,IDB_EXIT
		mov hExit,eax
